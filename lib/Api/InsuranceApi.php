...
class InsuranceApi
{
     ...
     */
    public function getInsurancePrices($accept_language = null, $datasource = null)
    {
        list($response) = $this->getInsurancePricesWithHttpInfo($accept_language, $datasource);
        return $response;
    }
     ...
     */
    public function getInsurancePricesWithHttpInfo($accept_language = null, $datasource = null)
    {
        // parse inputs
